 ...
 * @Created by GUO Yang
 */
public class NYCTaxiFormattedDataTestGeoMesaZ2Synthetic implements CommonData {
    ...
    public NYCTaxiFormattedDataTestGeoMesaZ2Synthetic(String queryFilename, String dataFilename) {
    ...
    public String getTypeName() {
        ...
        return "nyc-taxi-data-geomesa-z2";
    }
