 ...
 * @Created by GUO Yang
 */
public class NYCTaxiFormattedDataTestGeoMesaZ3SyntheticDay implements CommonData {
    ...
    public NYCTaxiFormattedDataTestGeoMesaZ3SyntheticDay(String queryFilename, String dataFilename) {
    ...
    public String getTypeName() {
        ...
        return "nyc-taxi-data-geomesa-z3-day";
    }
            ...
            try {
                ...
                try {
                    ...
                    while ((str = in.readLine()) != null) {
                        ...
                        long timestampMin = fromDateToTimestamp(timeMin);
                        String timeMax = items[2];
                        long timestampMax = fromDateToTimestamp(timeMax);
