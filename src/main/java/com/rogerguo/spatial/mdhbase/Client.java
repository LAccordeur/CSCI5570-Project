 ...
 * the License.
 */
package com.rogerguo.spatial.mdhbase;
...
public class Client implements Closeable {
  ...
  public Client(Configuration conf, String tableName, int splitThreshold) throws IOException {
    this.index = new Index(conf, tableName,
        splitThreshold);
  }
  ...
  public static void main(String[] args) throws IOException {
    ...
    Client client = new Client(conf, "Sample", 4);
    ...
    try {
      if (args.length == 0) {
        ...
        HTable index = new HTable(conf, TableName.valueOf("Sample_index"));
